...
int main(int argc, char **argv) {
    try {
        ...
        // Setup dynamics
        // [openarmx port] KDL chain links from openarmx_description v10 URDF
        // (root openarmx_body_link0 -> leaf openarmx_<side>_hand = 7 arm joints).
        std::string root_link = "openarmx_body_link0";
        std::string leaf_link =
            (arm_side == "left_arm") ? "openarmx_left_hand" : "openarmx_right_hand";
        ...
        openarmx::can::socket::OpenArmX *leader_openarm =
        ...
        openarmx::can::socket::OpenArmX *follower_openarm =
