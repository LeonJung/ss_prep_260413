...
int main(int argc, char** argv) {
    try {
        ...
        openarmx::can::socket::OpenArmX openarm(can_interface, true);  // Use CAN-FD on can0 interface

        // Initialize arm motors
        std::vector<openarmx::robstride_motor::MotorType> motor_types = {
            openarmx::robstride_motor::MotorType::DM8009, openarmx::robstride_motor::MotorType::DM8009,
            openarmx::robstride_motor::MotorType::DM4340, openarmx::robstride_motor::MotorType::DM4340,
            openarmx::robstride_motor::MotorType::DM4310, openarmx::robstride_motor::MotorType::DM4310,
            openarmx::robstride_motor::MotorType::DM4310};
        ...
        openarm.init_gripper_motor(openarmx::robstride_motor::MotorType::DM4310, 0x08, 0x18);

        // Set callback mode to ignore and refresh all motors
        openarm.set_callback_mode_all(openarmx::robstride_motor::CallbackMode::IGNORE);
        openarm.refresh_all();
        openarm.recv_all();
        ...
        openarm.set_callback_mode_all(openarmx::robstride_motor::CallbackMode::PARAM);
        openarm.query_param_all(static_cast<int>(openarmx::robstride_motor::RID::MST_ID));
        std::this_thread::sleep_for(std::chrono::milliseconds(100));
        ...
        for (const auto& motor : openarm.get_arm().get_motors()) {
            std::cout << "Arm Motor: " << motor.get_send_can_id() << " ID: "
                      << motor.get_param(static_cast<int>(openarmx::robstride_motor::RID::MST_ID))
                      << std::endl;
        }
        ...
        openarm.set_callback_mode_all(openarmx::robstride_motor::CallbackMode::STATE);

        // Control arm motors
        openarm.get_arm().send_motion_control_commands({openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
                                           openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
                                           openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
                                           openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
                                           openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
                                           openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0},
        ...
        openarm.get_gripper().send_motion_control_commands({openarmx::robstride_motor::MotionControlParam{0, 0, 0, 0, 0}});
