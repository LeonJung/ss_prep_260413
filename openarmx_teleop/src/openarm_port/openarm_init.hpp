...
public:
     ...
     */
    static openarmx::can::socket::OpenArmX *initialize_openarm(const std::string &can_device,
...
private:
     ...
     */
    static void initialize_(openarmx::can::socket::OpenArmX *openarm, const MotorConfig &config,
                            bool enable_debug);
};
