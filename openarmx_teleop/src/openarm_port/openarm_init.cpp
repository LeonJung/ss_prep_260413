...
openarmx::can::socket::OpenArmX *OpenArmInitializer::initialize_openarm(const std::string &can_device,
                                                                      bool enable_debug) {
...
openarmx::can::socket::OpenArmX *OpenArmInitializer::initialize_openarm(const std::string &can_device,
                                                                      ...
                                                                      bool enable_debug) {
    // Create OpenArmX instance.
    // [openarmx port] NOTE: OpenArmX's 2nd ctor arg is `can_fd` (NOT enable_debug like
    // openarm's OpenArm). Robstride motors don't support CAN-FD -> must be false.
    openarmx::can::socket::OpenArmX *openarm =
        new openarmx::can::socket::OpenArmX(can_device, /*can_fd=*/false);
...
void OpenArmInitializer::initialize_(openarmx::can::socket::OpenArmX *openarm,
