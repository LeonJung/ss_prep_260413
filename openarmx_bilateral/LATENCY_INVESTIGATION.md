...
- **update_rate: 150 (완전균일) 또는 160 (팔 기준, 그리퍼만 무관하게 down).** 170↑ 비추(손목 손해),
  200 비추(손목 59Hz). **미결: 운영자가 손목 써보며 150 vs 160 체감 비교 후 확정.** (현재 200이면 내릴 것.)
- **다음 검증:** 벽 느낌(transparency) 체감 / PC N 팡팡 재검증(원인이 USB tail 아니었으니 이 패치로 될 수도).
- **파킹:** 그리퍼 마찰보상(tech_debt §11), HS-USB 조달(A-1, 균일 rate 더 원할 때).
