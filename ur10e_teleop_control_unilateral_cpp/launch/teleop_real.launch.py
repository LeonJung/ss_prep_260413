...
Usage:
  ...
  ros2 launch ur10e_teleop_control_unilateral_cpp teleop_real.launch.py rt:=true
"""
...
def generate_launch_description():
    pkg_share = get_package_share_directory('ur10e_teleop_control_unilateral_cpp')
    ...
    leader = Node(
        package='ur10e_teleop_control_unilateral_cpp',
