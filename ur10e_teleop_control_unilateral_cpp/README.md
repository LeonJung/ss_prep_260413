...
```bash
cd <your_ws>
colcon build --packages-select ur10e_teleop_control_unilateral_cpp
...
```bash
colcon build --packages-select ur10e_teleop_control_unilateral_cpp  # no --symlink-install
```
...
```bash
# non-RT
ros2 launch ur10e_teleop_control_unilateral_cpp teleop_real.launch.py
...
```bash
# PC A — UR3e side
ros2 launch ur10e_teleop_control_unilateral_cpp teleop_real_leader.launch.py rt:=true

# PC B — UR10e side
ros2 launch ur10e_teleop_control_unilateral_cpp teleop_real_follower.launch.py rt:=true
```
...
`share/ur10e_teleop_control_unilateral_cpp/resources`.
