...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('couple_kp', default_value='0.0',
                              description='motor-side MIT coupling kp toward follower (0=Mode2 weightless; start 10-20)'),
        DeclareLaunchArgument('couple_kd', default_value='1.0',
                              description='motor-side MIT coupling kd (velocity damping)'),
